...
public final class GreetHelloWorldGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<demo2.HelloWorldRequest,
      demo2.HelloWorldResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = demo2.HelloWorldRequest.class,
      responseType = demo2.HelloWorldResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<demo2.HelloWorldRequest,
      demo2.HelloWorldResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<demo2.HelloWorldRequest, demo2.HelloWorldResponse> getSayHelloMethod;
      ...
      synchronized (GreetHelloWorldGrpc.class) {
        if ((getSayHelloMethod = GreetHelloWorldGrpc.getSayHelloMethod) == null) {
          GreetHelloWorldGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<demo2.HelloWorldRequest, demo2.HelloWorldResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.GreetHelloWorld", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  demo2.HelloWorldRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  demo2.HelloWorldResponse.getDefaultInstance()))
  ...
  public static abstract class GreetHelloWorldImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(demo2.HelloWorldRequest request,
        io.grpc.stub.StreamObserver<demo2.HelloWorldResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                demo2.HelloWorldRequest,
                demo2.HelloWorldResponse>(
  ...
  public static final class GreetHelloWorldBlockingStub extends io.grpc.stub.AbstractStub<GreetHelloWorldBlockingStub> {
    ...
    /**
     */
    public demo2.HelloWorldResponse sayHello(demo2.HelloWorldRequest request) {
  ...
  public static final class GreetHelloWorldFutureStub extends io.grpc.stub.AbstractStub<GreetHelloWorldFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<demo2.HelloWorldResponse> sayHello(
        demo2.HelloWorldRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((demo2.HelloWorldRequest) request,
              (io.grpc.stub.StreamObserver<demo2.HelloWorldResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetHelloWorldBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return demo2.HelloWorldProto.getDescriptor();
    }
